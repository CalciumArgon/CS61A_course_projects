...
if __name__ == '__main__':
    print("==== Testing utils.py here ====")
    words = "One long sentence, with ',' and '.' in it."
    print(split(words))
    only_words = remove_punctuation(words)
    print(only_words, list(only_words.split(" ")))
    
    many_space = "one two,    three"
    print(split(many_space))
    
    with_symbols = "With 'symbols' and '' in this one."
    print(remove_punctuation(with_symbols))
    
    tabs = "a b \tc"
    print(tabs, len(tabs))
    print(remove_punctuation(tabs), len(remove_punctuation(tabs)))
